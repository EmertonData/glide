...
### ✨ Added
- Added `ActiveSampler` in `glide/samplers/` for uncertainty-proportional active sampling (draws Bernoulli indicators with probability ∝ uncertainty, normalised to a target annotation budget)

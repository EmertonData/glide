...
from _utils import SQL_CORRECTNESS_CRITERIA, _load_checkpoint, _load_schemas, anthropic_judge, openai_judge
...
SYSTEM_PROMPT = (
    ...
    "determine whether the predicted SQL correctly answers the question. "
    "Be rigorous: verify that all column and table names exist in the schema, "
    "and that every requirement of the question is correctly implemented. "
    "Label a query as correct only if it fully and faithfully satisfies the question."
)

...
from glide.estimators import ClassicalMeanEstimator, StratifiedClassicalMeanEstimator
...
def test_two_equal_strata_matches_classical():
    ...
    y_single, _ = generate_gaussian_dataset(n_samples=n_labeled, random_seed=0)

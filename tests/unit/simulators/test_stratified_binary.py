...
def test_generate_stratified_binary_dataset_structure_and_counts(dataset_params):
    y_true, y_proxy, groups = generate_stratified_binary_dataset(**dataset_params, random_seed=0)
...
def test_generate_stratified_binary_dataset_delegates_validation(dataset_params):
    ...
    with (
        ...
        generate_stratified_binary_dataset(**dataset_params)
...
def test_generate_stratified_binary_dataset_reproducibility(dataset_params):
    y_true1, y_proxy1, groups1 = generate_stratified_binary_dataset(**dataset_params, random_seed=42)
    y_true2, y_proxy2, groups2 = generate_stratified_binary_dataset(**dataset_params, random_seed=42)
...
def test_generate_stratified_binary_dataset_different_seed_results_differ(dataset_params):
    dataset_params = {**dataset_params, "n_samples": [5, 5]}
    y_true1, y_proxy1, _ = generate_stratified_binary_dataset(**dataset_params, random_seed=0)
    y_true2, y_proxy2, _ = generate_stratified_binary_dataset(**dataset_params, random_seed=1)

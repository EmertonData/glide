...
def test_fit_tuning_parameter_power_tuning_true(engine, y_true, y_proxies):
    dataset = engine.preprocess(y_true, y_proxies)
...
def test_fit_tuning_parameter_power_tuning_false(engine, y_true, y_proxies):
    dataset = engine.preprocess(y_true, y_proxies)
...
def test_compute_mean_and_std(engine, y_true, y_proxies):
    dataset = engine.preprocess(y_true, y_proxies)

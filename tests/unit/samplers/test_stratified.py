...
def test_sample_different_seeds_results_differ(sampler, y_proxy, groups):
    xi1 = sampler.sample(y_proxy, groups, 4, random_seed=0)
    xi2 = sampler.sample(y_proxy, groups, 4, random_seed=1)

...
def test_preprocess_valid_output(estimator, y_true, y_proxy, clusters):
    labeled_true_means, labeled_proxy_means, unlabeled_proxy_means, labeled_total_size = estimator._preprocess(
        y_true, y_proxy, clusters
    )

...
def test_compute_bootstrap_labeled_means_known_result(rng):
    ...
    y_true_means, y_proxy_means = _compute_bootstrap_labeled_means(y_true, y_proxy_labeled, n_bootstrap=4, rng=rng)
...
def test_compute_bootstrap_mean_estimates_known_result(bootstrap_y_true_means, bootstrap_y_proxy_labeled_means, rng):

...
def test_compute_ppi_mean_estimate_known_values(y_true, y_proxy_labeled, y_proxy_unlabeled):
    expected = 6.75
    result = _compute_ppi_mean_estimate(y_true, y_proxy_labeled, y_proxy_unlabeled, lambda_=0.5)
...
def test_compute_ppi_std_estimate_known_values(y_true, y_proxy_labeled, y_proxy_unlabeled):
    expected = 0.41
    result = _compute_ppi_std_estimate(y_true, y_proxy_labeled, y_proxy_unlabeled, lambda_=0.5)

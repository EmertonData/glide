"""
Generate human-grade labels for Spider predictions using claude-opus-4-7.

Run from the repo root after generate_predictions.py:
    python spider_case_study/scripts/generate_human_labels.py
...
OUTPUT_PATH = Path(__file__).parent.parent / "data" / "human_labels.jsonl"
...
{{"label": <0 or 1>, "reasoning": "<detailed justification>"}}

Where label=1 means the predicted SQL is correct (semantically equivalent to gold), and label=0 means incorrect.\
"""
    ...
    with open(OUTPUT_PATH, "a") as out_f:
        for i, ex in enumerate(remaining):
            ...
            record = {
                ...
                "human_reasoning": parsed["reasoning"],
            }

...
SYSTEM_PROMPT = (
    ...
    "Given a question, the gold (correct) SQL, and the predicted SQL, determine if the "
    "predicted SQL is semantically equivalent to the gold SQL and would return the same results."
)
